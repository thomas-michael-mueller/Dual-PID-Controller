...
public final class ActivityAppInfoBinding implements ViewBinding {
  ...
  private ActivityAppInfoBinding(@NonNull LinearLayout rootView, @NonNull MaterialToolbar toolbar,
  ...
  public static ActivityAppInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAppInfoBinding((LinearLayout) rootView, toolbar, versionText);
    }
